<%@ Page Title="" Language="C#" MasterPageFile="~/mas/masReporte.master" AutoEventWireup="true" CodeFile="repPrincipal.aspx.cs" Inherits="repPrincipal" %>
                ...
                <table runat="server" id="lista" class="lista">
                    <thead>
                        <tr>
                            ...
                            <th id="Th5" style="width:25%">
                                <%= Resources.resDiccionario.Grupo %>
                            </th>                       
                             <th id="Th4" style="width:8%">
            ...
            <ItemTemplate>
                <tr id="Tr1" runat="server">
                    <td id="Td1" runat="server">
                        ...
                        <asp:HiddenField ID="hfIdGrupoReporte" runat="server" Value='<%# Eval("IdGrupoReporte") %>' />
