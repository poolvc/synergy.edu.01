...
namespace Synergy.Presentation.Web
{
    class MapData
    {
        public void MapObjects(object sourceObject, object targetObject)
        {
        ...
        public List<T> ConvertTo<T>(IDataReader dr) where T : new()
        {
        ...
        /// </code></example>
        public IList<T> ConvertToList<T>(DataTable dt) where T : class, new()
        {
        ...
        /// DataTable dt = DataUtil.ConvertToDataTable(people);
        /// </code></example>
        public DataTable ConvertToDataTable<T>(IList<T> list) where T : class
        {
        ...
        /// </summary>
        public DataTable CreateDataTable<T>() where T : class
        {
            Type objType = typeof(T);
        ...
        /// </summary>
        public T ConvertDataRowToEntity<T>(DataRow row) where T : class, new()
        {
            Type objType = typeof(T);
